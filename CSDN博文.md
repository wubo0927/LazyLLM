...
- **智能问答**：基于文档内容回答用户问题
- **工具调用**：支持多种搜索工具（学生信息、前端经验、GPA比较等）
...
-  **多工具支持**：支持文档搜索、前端经验分析、GPA比较等多种专业工具
...
```bash
# 克隆项目
git clone https://github.com/wubo0927/LazyLLM.git
cd LazyLLM
...
项目已上传至GitHub：https://github.com/wubo0927/LazyLLM
